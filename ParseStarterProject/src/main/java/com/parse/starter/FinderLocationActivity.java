...
public class FinderLocationActivity extends FragmentActivity implements OnMapReadyCallback {
                ...
                if (e == null) {
                    ...
                    if (objects.size() > 0) {
                        ...
                        for (ParseObject object : objects) {
                            ...
                            //object.put("phone",ParseUser.getCurrentUser().getString("phone"));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finder_location);
