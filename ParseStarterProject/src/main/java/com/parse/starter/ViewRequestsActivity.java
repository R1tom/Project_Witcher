...
public class ViewRequestsActivity extends AppCompatActivity {
    ...
    public void updateListView(Location location) {
        ...
        if (location != null) {
            ...
            query.whereDoesNotExist("HelperName");
                        ...
                        if (objects.size() > 0) {
                            ...
                            for (ParseObject object : objects) {
                                ...
                                if (requestLocation != null) {
                                    ...
                                    Double distanceInKilometersTo = geoPointLocation.distanceInKilometersTo(requestLocation);

                                    Double distanceOneDP = (double) Math.round(distanceInKilometersTo * 10) / 10;

                                    requests.add(distanceOneDP.toString() + " Kilo-meter");
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (Build.VERSION.SDK_INT < 23 || ContextCompat.checkSelfPermission(ViewRequestsActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                        ...
                        if (requestLatitudes.size() > i && requestLongitudes.size() > i && usernames.size() > i && lastKnownLocation != null) {
                            ...
                            Intent intent = new Intent(getApplicationContext(), FinderLocationActivity.class);
